  ...
  map: {
    ...
    basemaps: [
      ...
      [{
        ...
        type: 'wmts',
        useProxy: false,
        url: 'http://19.15.73.111/arcgisserver12/rest/services/国土空间规划底图/实施监督预警底图/MapServer'
      }]
    ],
    maskService: {
      disable: false,
      title: '行政区划边界服务',
      type: 'image',
      url: 'http://19.15.73.111/arcgisserver12/rest/services/广东省界合并2000/MapServer',
      symbol: {
        type: 'simple-fill',
    ...
    xzqhService: {
      ...
      title: '广东省地市边界图层',
      id: 'XZQHLayer',
      url: 'http://19.15.73.111/arcgisserver12/rest/services/广东省行政区界线/Boundary/MapServer/0',
      url2: 'http://120.77.57.182:6080/arcgis/rest/services/test/区划/MapServer/0',
      url3: 'http://19.15.73.111/arcgisserver12/rest/services/广东省行政区界线/MyMapService/MapServer/0',
      url4: 'http://19.15.73.111/arcgisserver12/rest/services/广东省行政区界线/广东省县区界限/MapServer/0',
      colors: [
        [230, 209, 192, 0.8],
        [245, 248, 195, 0.8],
        [208, 231, 207, 0.8]
