...
export default {
  ...
  created () {
    ...
    this.folderType = this.$route.query.folderType
    if (this.document.name.indexOf('.html') != -1) {
      // this.iframeSrc
      //   = '/api/epf-document/document/showContentById?id='
      //   + this.$route.query.row.id
      this.iframeSrc
        = `/api/epf-document/document/showContentById?id=${this.$route.query.row.id}&token=${sessionStorage.getItem('token')}`
    } else if (
      this.document.extName == 'txt'
      || this.document.extName == 'TXT'
      || this.document.extName == 'pdf'
      || this.document.extName == 'PDF'
    ) {
      // this.iframeSrc
      ...
      //   + this.$route.query.row.id
      this.iframeSrc
        = `/api/epf-document/document/showFtpFileByid?id=${this.$route.query.row.id}&token=${sessionStorage.getItem('token')}`
    } else {
      // this.iframeSrc
