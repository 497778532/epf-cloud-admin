            ...
            <el-tabs>
              <div class="switchHeight_box">
                <div style="font-size: 28px;font-weight: bold;display: flex;align-items: center;">
                  <span v-if="this.$route.query.folderType==1">公共文档审核记录</span>
                  <span v-if="this.$route.query.folderType==3">单位文档审核记录</span>
                </div>
                ...
                <!-- 搜索切换 -->
                <div style="width:500px;display:flex;align-items: center;justify-content: flex-end;">
              ...
              <div class="main-table">
                ...
                <el-table-column prop="docNo" label="操作" min-width="70">
                  <template slot-scope="scope">
                    <div class="cell_click" @click="uploadWrokFile">
                      <span style="color:#4E88FE;cursor" v-if="scope.row.examineState == '1'">重新上传</span>
                    </div>
                  </template>
                </el-table-column>
                -->
  ...
  methods: {
    ...
    async getDocList (params) {
      ...
      if (this.folderType == '1') {
        this.$get('/epf-document/docdocumentinfo/getMyExamineRecordPlanningDocs', params).then(res => {
          console.log('871===========', res)
          if (res.code != '0') {
        ...
        this.$get('/epf-document/docdocumentinfo/getMyExamineRecordWorkDocs', params).then(res => {
          console.log('871===========', res)
          if (res.code != '0') {
            this.$message.error(res.msg) // 失败
            this.loading = false
