  ...
  <div class="page-body EPF-table"
    ...
    <div class="filter_wrap">
      <div class="SelectButton">
        ...
        <el-button @click="addAssess">新增评估</el-button>
        <el-button icon="el-icon-finished" @click="flexSwitch">筛选类别</el-button> -->
        <div class="button_kuang"
             @click="batchExport">导出</div>
        <div class="button_kuang"
             @click="addAssess">新增评估</div>
      ...
      <div class="switchHeight_box"
        ...
        <el-row style="margin-bottom:20px;">
          <el-col :span="6"
            ...
            <span class="filter_title__custom">评估编号：</span>
            <el-input v-model="filterData.evaluatioNumber"
                      size="small"
          ...
          <el-col :span="6"
                  class="filter_title_box">
            <span class="filter_title__custom">评估区域：</span>
          ...
          <el-col :span="6"
                  class="filter_title_box">
            <span class="filter_title__custom">所属年份：</span>
          ...
          <el-col :span="6"
            ...
            <span class="filter_title__custom_three">创建人：</span>
            <el-input v-model="filterData.createUserName"
                      size="small"
        ...
        <el-row style="margin-bottom:0px;">
          <el-col :span="9"
                  class="filter_title_box">
            <span class="filter_title__custom">评估时间：</span>
            <el-date-picker v-model="pingguTime"
                            type="daterange"
                            align="right"
                            unlink-panels
                            range-separator="至"
      ...
      <el-tabs style="margin-top:24px;">
        <!-- <div class="toolsTitleBox">
          <span class="toolsTitle">评估列表</span>
          <div class="oper">
        ...
        <el-table ref="multipleTable"
                  ...
                  border>
          <el-table-column prop="evaluatioNumber"
                           label="评估编号"
                           min-width="250"
                           align="center"></el-table-column>
          <el-table-column prop="placeName"
                           label="评估区域"
                           min-width="200"
                           align="center"></el-table-column>
          <el-table-column label="创建人"
            ...
            <template slot-scope="scope">
              <span style="color:#70b603;">{{scope.row.createUserName}}</span>
            </template>
          </el-table-column>
          ...
          <el-table-column prop="year"
                           ...
                           min-width="200"
                           align="center"></el-table-column>
          <el-table-column prop="evaluatioVersion"
                           label="评估版本"
                           min-width="200"
                           align="center"></el-table-column>
          <el-table-column prop="createTime"
                           ...
                           min-width="300"
                           align="center"></el-table-column>
          <el-table-column label="评估报告"
                           min-width="200"
                           align="center">
            <template slot-scope="scope">
              <el-button type="text"
                         size="small"
                         @click="handelClickDownload(scope.row)">下载</el-button>
            </template>
          </el-table-column>
          <el-table-column label="操作"
            ...
            <template slot-scope="scope">
              <el-button type="text"
                         size="small"
                         @click="handelClickCheck(scope.row)">查看评估结果</el-button>
            </template>
          </el-table-column>
        </el-table>
...
export default {
  ...
  methods: {
    ...
    handelClickCheck (item) {
      ...
      let routerPath = `assesscenter?id=${item.id}`
    ...
    getList () {
      ...
      this.$get(
        '/epf-monitor-evaluation/evalutionMonitor/getPageInfo',
        params
      ).then(res => {
        if (res.code == '0') {
          this.assessList = res.pager.results
          this.pageNo = res.pager.pageNo
          this.pageSize = res.pager.pageSize
          this.totalPage = res.pager.totalPage
          this.totalRecord = res.pager.totalRecord

          for (var key in this.assessList) {
            if (this.assessList[key].province != '') {
              let index = key
              if (this.assessList[key].city != '') {
                let index = key
                if (this.assessList[key].area != '') {
                  let index = key
                  this.assessList[index]['placeName'] = this.assessList[
                    index
                  ].cantonAreaName
                } else {
                  this.assessList[index]['placeName'] = this.assessList[
    ...
    searchList () {
      ...
      this.params['area'] = this.areaSelectedOptions[2]
      if (this.pingguTime) {
        this.params['startTime'] = this.pingguTime[0]
        this.params['endTime	'] = this.pingguTime[1]
      }
      this.getList()
    },
