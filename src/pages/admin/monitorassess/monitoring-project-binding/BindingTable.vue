  ...
  <div class="page-body"
    ...
    <div class="page-warning__con EPF-table"
      ...
      <div class="warning-table"
        ...
        <div class="switchHeight_box">
          <el-row style="margin:22px 0;">
            <el-col :span="5"
              ...
              <span class="filter_title__custom">行政区域：</span>
              <el-cascader :props="props"
                           ref="bindingArea"
                           clearable
                           v-model="areaSelectedOptions"
                           @change="areaSelect()"
                           :placeholder="this.jilianPHolder"
                           style="width:calc(100% - 120px);"></el-cascader>
            </el-col>
            <el-col :span="5"
                    class="filter_title_box">
              <span class="filter_title__custom">区域格局：</span>
            ...
            <el-col :span="5"
                    class="filter_title_box">
              <span class="filter_title__custom">区域划分：</span>
            ...
            <el-col :span="5"
                    class="filter_title_box">
              <span class="filter_title__custom">预警状态：</span>
        ...
        <div style="width:100%;padding:10px 16px 0;min-height:635px;">
