      ...
      <el-form label-width="100px">
        ...
        <div class="tabContent"
          ...
          <el-row style="margin-top:10px;"
            ...
            <el-col :span="8"
                    style="display:flex;justify-content:center;">
              <!-- <span style="width:115px;height:30px;display:block;background:#FCE0BC;"></span> -->
...
export default {
  ...
  methods: {
    ...
    getMapData () {
      ...
      console.log('区域名称数据', this.jsonData.cityNameData) // ["广州市", "珠海市", "深圳市"]
    ...
    async loadMap (mapCode, name) {
      ...
      if (data) {
        ...
        var option = commonecharts.makePie(this.jsonData, name, centerId)

        if (option && typeof option === 'object') {
          myChart.setOption(option, true)
        }
        /* pie*/
        commonecharts.addPie(myChart, option, this.jsonData, mapCenter)
