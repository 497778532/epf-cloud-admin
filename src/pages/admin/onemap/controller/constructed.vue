  ...
  <div v-if="constructedDialog"
    ...
    <div class="data_content_different">
      ...
      <div class="content_table">
        <div class="content_title">压覆矿产资源数量：5个</div>
        <!-- <div class="content_title">压覆矿产资源数量：{{this.tableNumber}}个</div> -->
      ...
      <el-table :data="dataList"
                ...
                border>
        <el-table-column prop="biaoshima"
                         label="标识码"
                         min-width="120"
                         align="center"></el-table-column>
        <el-table-column prop="kcNmae"
                         label="矿产名称"
                         min-width="250"
                         align="center"></el-table-column>
        ...
        <el-table-column prop="value"
                         ...
                         min-width="150"
                         align="center"></el-table-column>
        <el-table-column prop="zykcName"
                         label="主要矿产名称"
                         min-width="150"
                         align="center"></el-table-column>
        <el-table-column prop="zykcMessage"
                         label="主要矿产储存情况"
                         min-width="150"
                         align="center"></el-table-column>
  ...
  methods: {
    ...
    showExport (type) {
      if (type === 'chart') {
        ...
        this.exportRaw('压覆矿分析结果.txt', result)
      } else if (type === 'execl') {
      }
    },
    fakeClick (obj) {
