<template>
  <div v-if="disasterareaDialog"
       id="disasterarea"
       v-drag
       class="EPF-table">
    <div class="data_title_different drag-title">
      <span>地质灾害易发区分析结果</span>
    ...
    <div class="data_content_different">
      ...
      <div class="content_table">
        <!-- <div class="content_title">地质灾害易发区数量：5个</div> -->
        <!-- <div class="content_title">地质灾害易发区数量：{{this.tableNumber}}个</div> -->
      ...
      <el-table :data="dataList"
        ...
        <el-table-column prop="zhName"
                         label="地质灾害易发区名称"
                         min-width="250"
                         align="center"></el-table-column>
        <el-table-column prop="fanwei"
                         label="影响范围"
                         min-width="150"
                         align="center"></el-table-column>
        <el-table-column prop="landName"
                         label="地类名称"
                         min-width="150"
                         align="center"></el-table-column>
  ...
  methods: {
    ...
    getSpanArr (data) {
      ...
      data.forEach((item, index) => {
        ...
        if (index === 0) {
          ...
          // 不是第一项时，就根据标识去存储
          if (data[index].zhName === data[index - 1].zhName) {
    ...
    showExport (type) {
      if (type === 'chart') {
        ...
        this.exportRaw('地质灾害易发区分析结果.txt', result)
      } else if (type === 'execl') {
      }
    },
    fakeClick (obj) {
