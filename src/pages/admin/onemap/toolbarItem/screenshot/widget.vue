    ...
    <div id="screenshotDiv"
      ...
      <div id="btnBox">
        <button id="downloadBtn"
                class="action-button"
                title="下载图片"
                @click="downloadBtnClick">下载图片</button>
        <button id="closeBtn"
                class="action-button"
                title="回到地图"
                @click="closeBtnClick">回到地图</button>
      </div>
    </div>
    <div id="maskDiv"
         class="hide"></div>
...
export default {
  ...
  computed: {
    ...mapGetters(['getScreenshotState'])
  },

  watch: {
    getScreenshotState: function (state) {
      if (state) {
        this.startup()
      }
    }
  ...
  methods: {
    ...
    downloadBtnClick (event) {
      ...
      this.$store.dispatch('onemap/setScreenshotState', false)
    },
    closeBtnClick () {
